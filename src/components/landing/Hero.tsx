...
import { ExternalLink, Users, Play, Sparkles, RocketIcon } from 'lucide-react';
      ...
      <div className="container mx-auto py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="space-y-8"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/5 border border-orange-500/20 text-sm">
              <Badge variant="outline" className="bg-orange-500/10 text-orange-600 border-orange-500/20">
                Stacks Testnet
              </Badge>
              <span className={cn(
                "text-orange-600 font-bold tracking-tight",
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-xl">
                The fastest way to write, validate, and deploy Clarity contracts to Stacks testnet — secured by Bitcoin.
                <span className="block mt-2">Zero configuration. Instant development.</span>
              </p>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-orange-500 via-orange-400 to-amber-400 opacity-90 transition-opacity group-hover:opacity-100" />
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm">
                ...
                <span className="text-muted-foreground">building on Stacks</span>
              </div>
            </div>
          </motion.div>
