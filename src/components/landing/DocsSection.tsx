...
const RESOURCES = [
  {
    ...
    description: "Writing Your First Clarity Smart Contract",
  ...
  },
  {
    ...
    description: "Stacks Documentation & Clarity Language Reference",
  ...
  },
  {
    ...
    description: "Join the Stacks Developer Discord Community",
    ...
    <section className="container mx-auto py-24 lg:py-32">
      ...
      >
        ...
        <p className="text-lg text-muted-foreground">
          Everything you need to get started with Clarity development
        </p>
      </motion.div>
