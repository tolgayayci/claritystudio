      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="sm:max-w-[420px] p-0 border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-xl">
          <DialogHeader className="sr-only">
            <DialogTitle>Sign in to Clarity Studio</DialogTitle>
          </DialogHeader>
          ...
          <div className="px-6 pt-6 pb-4 text-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Sign in to start building on Stacks
            </p>
          </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="h-10 border-gray-300 dark:border-gray-700 focus:border-orange-500 focus:ring-orange-500"
                      disabled={isLoading}
                    />
                  </div>
          ...
          <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50">
            <p className="text-xs text-center text-gray-500 dark:text-gray-400">
              ...
              <a href="#" className="text-orange-600 hover:text-orange-700 underline underline-offset-4">
                Terms
              </a>{' '}
              and{' '}
              <a href="#" className="text-orange-600 hover:text-orange-700 underline underline-offset-4">
