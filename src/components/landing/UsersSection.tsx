...
const USER_TYPES = [
  {
    ...
    benefits: [
      ...
      },
      {
        ...
        description: 'Built-in STX testnet wallet for seamless deployment.',
      },
      {
        icon: Share2,
  ...
  },
  {
    id: 'newbies',
    icon: GraduationCap,
    title: 'Clarity Beginners',
    description: 'Start your Stacks journey with a guided, hassle-free experience.',
    benefits: [
      {
        icon: BookOpen,
      ...
      },
      {
        ...
        description: 'Instant validation and error checking.',
      },
      {
        icon: Code2,
        title: 'Zero Setup',
  ...
  },
  {
    ...
    description: 'Streamlined environment for efficient Clarity development.',
    benefits: [
      {
        icon: Rocket,
      ...
      },
      {
        ...
        description: 'Integrated validation and deployment pipeline.',
      },
      {
        icon: GitBranch,
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <Badge variant="outline" className={cn(
                        ...
                        type.id === 'hackathon' && "bg-emerald-500/10 text-emerald-500",
                  ...
                  {type.benefits.map((benefit, i) => (
                    <div key={i} className="flex items-start gap-3">
                      <div className={cn(
                        ...
                        type.id === 'hackathon' && "bg-emerald-500/10",
                        ...
                        <benefit.icon className={cn(
                          "h-4 w-4",
                          type.id === 'hackathon' && "text-emerald-500",
