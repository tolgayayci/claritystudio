...
const USE_CASES = [
  {
    ...
    description: 'Test your smart contracts directly in the browser. Call public functions, read state, and see results instantly.',
    features: [
  ...
  {
    icon: Box,
    title: 'Clarity Contract Analysis',
    description: "Validate your Clarity source code for syntax and semantic correctness. Understand your contract's behavior before deployment.",
    features: [
      'Syntax validation',
      'Semantic analysis',
  ...
  },
  {
    ...
    description: 'Interact with deployed contracts using the auto-generated interface. Read contract state and call functions with a visual UI.',
    features: [
