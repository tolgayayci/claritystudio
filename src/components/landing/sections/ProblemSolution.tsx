  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 15; i++) {
      lines.push({
        ...
        color: i % 2 === 0 ? '239, 68, 68' : '255, 85, 0' // red vs orange
      });
    }
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-xl text-gray-500 font-light">
            Traditional setup: 30 minutes. Clarity Studio: 30 seconds. The math is simple.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-32 transition-all duration-700 hover:gap-20">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-500">You have a brilliant idea for a Clarity smart contract</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-75">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-500">Installing clarinet, configuring Stacks node...</div>
                </div>
              </div>
          ...
          <div>
            <div className="mb-8">
              <div className="text-sm font-medium text-orange-600 uppercase tracking-wider mb-2">After</div>
              <h3 className="text-3xl font-semibold text-gray-900">Clarity Studio</h3>
            </div>

            <div className="space-y-6">
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300">
                <div className="text-2xl font-light text-orange-600 w-12 animate-pulse">0s</div>
                <div className="flex-1">
                  <div className="font-medium text-gray-900">Open browser</div>
                  <div className="text-gray-500">Visit Clarity Studio</div>
                </div>
              </div>

              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-75">
                <div className="text-2xl font-light text-orange-600 w-12">10s</div>
                <div className="flex-1">
              ...
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-100">
                <div className="text-2xl font-light text-orange-600 w-12">20s</div>
                <div className="flex-1">
                  <div className="font-medium text-gray-900">Validate & check</div>
                  <div className="text-gray-500">One-click syntax and semantic validation</div>
                </div>
              </div>

              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-150">
                <div className="text-2xl font-light text-orange-600 w-12">30s</div>
                <div className="flex-1">
                  <div className="font-medium text-gray-900">Deploy live</div>
                  <div className="text-gray-500">Your contract is on Stacks testnet</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 p-6 bg-orange-50 rounded-2xl">
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-orange-600">30</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-gray-50 rounded-2xl hover:scale-105 transition-transform duration-300 cursor-default">
              ...
              <p className="text-gray-500 text-sm">
                Deploy to Stacks testnet with a pre-funded wallet. No wallet setup, no faucet requests. Just deploy.
              </p>
            </div>
            ...
            <div className="p-6 bg-gray-50 rounded-2xl hover:scale-105 transition-transform duration-300 cursor-default">
              ...
              <p className="text-gray-500 text-sm">
                Clarity is interpreted on-chain and decidable. No reentrancy attacks, no hidden bugs. Source code is fully auditable and transparent.
              </p>
            </div>
            ...
            <div className="p-6 bg-gray-50 rounded-2xl hover:scale-105 transition-transform duration-300 cursor-default">
              ...
              <p className="text-gray-500 text-sm">
                Explore templates for SIP-010 tokens, SIP-009 NFTs, and more. Build on top of battle-tested Clarity code.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-gray-500">
                  Join <span className="font-semibold text-gray-900">developers</span> building on Clarity Studio
                </p>
              </div>
            </div>
            <button
