...
const traditionalSteps = [
  { time: 0, task: 'Install Clarinet CLI', status: 'waiting', duration: 15 },
  { time: 15, task: 'Install dependencies', status: 'waiting', duration: 10 },
  { time: 25, task: 'Setup environment', status: 'waiting', duration: 10 },
  { time: 35, task: 'Configure project', status: 'waiting', duration: 15 },
  { time: 50, task: 'Create contract', status: 'waiting', duration: 5 },
  { time: 55, task: 'Write Clarity code', status: 'waiting', duration: 20 },
  { time: 75, task: 'Validate contract', status: 'waiting', duration: 10 },
...
const playgroundSteps = [
  ...
  { time: 2, task: 'Create new project', status: 'waiting', duration: 3 },
  { time: 5, task: 'Write Clarity code', status: 'waiting', duration: 15 },
  { time: 20, task: 'Click Check', status: 'waiting', duration: 3 },
  { time: 23, task: 'Deploy instantly', status: 'waiting', duration: 7 },
];
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    {timePosition >= 15 && timePosition < 25 && (
                      <motion.div
                        ...
                        exit={{ opacity: 0 }}
                      >
                        <p className="text-gray-400">$ brew install clarinet</p>
                    ...
                    {timePosition >= 25 && (
                      <motion.div
                        ...
                        exit={{ opacity: 0 }}
                      >
                        <p className="text-gray-400">$ clarinet check contracts/*.clar</p>
                        <p className="text-red-400">Error: type mismatch on line 12</p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
