    ...
    <section className="relative py-24 px-6">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            { icon: Code2, label: 'Contracts Validated', value: metrics.compilations.toLocaleString(), color: 'text-teal-400' },
            ...
            { icon: Activity, label: 'STX Faucet Requests', value: metrics.gasOptimized, color: 'text-orange-400' }
          ].map((metric, i) => (
