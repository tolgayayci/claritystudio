...
(define-data-var message (string-ascii 100) "Hello, Stacks!")

(define-public (set-greeting (new-message (string-ascii 100)))
  (begin
...
(define-read-only (get-greeting)
  (ok (var-get message)))`,
  challenge: `;; Counter Contract - Find the Bug!
(define-data-var counter uint u0)

(define-public (increment)
  (begin
    ;; FIX ME: This doesn't actually increment!
    (var-set counter (var-get counter))
    (ok (var-get counter))))

(define-read-only (get-counter)
  (ok (var-get counter)))`,
  fixed: `;; Counter Contract - Fixed!
(define-data-var counter uint u0)
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Write and validate Clarity smart contracts right here. No account needed.
          </p>
        </motion.div>
                    ...
                    <div className="flex-1 p-6">
                      ...
                      <div className="bg-gray-900/50 rounded-lg p-4 font-mono text-sm min-h-[400px]">
                        {!compilationResult && !isCompiling && (
                          <p className="text-gray-500">Click 'Check' to validate your contract...</p>
                        )}

                        {isCompiling && (
                          <div className="space-y-2">
                            <p className="text-blue-400">→ Parsing Clarity syntax...</p>
                            <p className="text-blue-400">→ Checking types and definitions...</p>
                            <p className="text-blue-400">→ Verifying contract structure...</p>
                          </div>
                        )}
                        ...
                        {compilationResult === 'success' && (
                          <div className="space-y-2">
                            ...
                            <p className="text-gray-400">No syntax errors found</p>
                            <p className="text-gray-400">Ready for deployment to Stacks testnet</p>

                            <div className="mt-4 p-3 bg-gray-800/50 rounded">
                              <p className="text-gray-300 mb-2">Available functions:</p>
                              <ul className="text-teal-400 space-y-1">
                                <li>• (get-greeting) → (response string-ascii)</li>
                                <li>• (set-greeting msg) → (response bool)</li>
                              </ul>
                            </div>
                          </div>
                        )}
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="bg-gray-700/30 border-gray-600 p-6">
                    <h3 className="text-xl font-semibold text-white mb-3">
                      Challenge 1: Hello Stacks
                    </h3>
                    <p className="text-gray-400 mb-4">
                      Create a simple greeting contract that stores and returns a message using Clarity.
                    </p>
                    <Button
