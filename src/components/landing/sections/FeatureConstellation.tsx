...
const features = [
  {
    ...
    description: 'Clarity smart contracts with syntax highlighting',
  ...
  },
  {
    ...
    description: 'Instant Clarity syntax validation',
    details: ['Syntax checking', 'Type analysis', 'Error highlighting'],
    x: 80,
    y: 50,
    size: 'medium'
  },
  {
    ...
    description: 'One-click deployment to Stacks testnet',
  ...
  },
  {
    ...
    details: ['Method execution', 'Transaction history', 'ABI interface'],
    x: 60,
    y: 70,
    size: 'medium'
  },
